...
namespace WindowLib
{
        ...
        Window(logger)
    {
        ...
        // Register window class once. CS_HREDRAW | CS_VREDRAW invalidate the client area on
        // resize so DWM immediately requests a repaint via WM_PAINT, eliminating
        // stale-content artefacts. hbrBackground = BLACK_BRUSH gives DWM a defined fill
        // colour for any client-area pixels not yet written by the Vulkan swapchain (e.g.
        ...
        // With DWM compositing enabled, BLACK_BRUSH paints immediately and the window
        // appears as a solid black rectangle until Vulkan takes over.
